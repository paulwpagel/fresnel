...
[
  ...
  "production",
  "production/lib",
  "production/__resources/gems/fresnel_lib-0.0.22/lib"
...
def create_mock_project(name = "One")
  return mock(Lighthouse::Project, :open_tickets => [], :milestone_titles => [""], :hyphenated_name => nil, :tag_names => [], :destroy_ticket => nil, :create_milestone => nil, :delete_milestone => nil,
                                       :id => nil, :tickets_for_tag => [], :user_names => [""], :update_tickets => nil, :user_id => nil, :ticket_title => nil, :register_milestone_observer => nil,
