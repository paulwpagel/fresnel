...
def mock_lighthouse
  ...
  @stage_info = mock("stage_info", :credential => nil, :client => @lighthouse_client)
  @stage_manager = mock("stage_manager", :[] => @stage_info, :notify_of_project_change => nil, :current_project => @project)
