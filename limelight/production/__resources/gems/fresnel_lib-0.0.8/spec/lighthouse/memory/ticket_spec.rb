...
describe Lighthouse::Ticket do
  ...
  it "should have a title" do
    @ticket.title.should == "Some Project"
  end
  ...
  it "should accept a state on init" do
    ticket_two = Lighthouse::Ticket.new(:project_id => @project.id, :state => "open")
    
    ticket_two.state.should == "open"
  end
